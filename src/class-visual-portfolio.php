...
class Visual_Portfolio {
    ...
    public function register_scripts() {
        ...
        if ( apply_filters( 'vpf_enqueue_plugin_font_awesome', true ) ) {
            wp_register_script( 'font-awesome', visual_portfolio()->plugin_url . 'assets/vendor/font-awesome/all.min.js', array(), '5.2.0', true );
            wp_register_script( 'font-awesome-v4-shims', visual_portfolio()->plugin_url . 'assets/vendor/font-awesome/v4-shims.min.js', array( 'font-awesome-v4-shims' ), '5.2.0', true );
