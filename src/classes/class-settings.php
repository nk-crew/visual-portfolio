...
require_once visual_portfolio()->plugin_path . 'src/vendors/class-settings-api.php';
...
class Visual_Portfolio_Settings {
    ...
    public static function admin_enqueue_scripts( $page ) {
        if ( 'portfolio_page_visual-portfolio-settings' === $page || 'toplevel_page_visual-portfolio-settings' === $page ) {
            ...
            wp_enqueue_script( 'visual-portfolio-archive-page-selector', visual_portfolio()->plugin_url . 'assets/admin/js/archive-page-selector.min.js', array( 'jquery', 'select2' ), VISUAL_PORTFOLIO_VERSION, true );
