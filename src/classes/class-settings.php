...
class Visual_Portfolio_Settings {
    ...
    public static function get_settings_sections() {
        $sections = array(
            ...
            array(
                'id'    => 'vp_popup_gallery',
                'title' => esc_html__( 'Popup & Lightbox', '@@text_domain' ),
            ...
            array(
                ...
                'title' => esc_html__( 'Social Feeds', '@@text_domain' ),
    ...
    public static function get_settings_fields() {
        ...
        $settings_fields = array(
            'vp_general' => array(
                ...
                array(
                    'name'    => 'social_logs',
                    'label'   => esc_html__( 'Social Logs', '@@text_domain' ),
                    'desc'    => esc_html__( 'Enable Social Logs for Twitch (Beta)', '@@text_domain' ),
                    'type'    => 'toggle',
                    'default' => class_exists( 'Visual_Portfolio_Pro' ) ? 'on' : 'off',
                    'is_pro'  => true,
                ),
                array(
                    ...
                    'label'       => esc_html__( 'Logs Limit', '@@text_domain' ),
                    'type'        => 'number',
                    'min'         => 50,
                    'max'         => 1000,
                    'default'     => 100,
                    'desc'        => esc_html__( 'Sets the maximum logs limit.', '@@text_domain' ),
                    'is_pro'      => true,
                    'condition'   => array(
                        array(
            ...
            'vp_images' => array(
                ...
                array(
                    ...
                    'label'   => esc_html__( 'Lightbox Image Sizes', '@@text_domain' ),
                    'desc'    => __( 'Image sizes used in lightbox images.', '@@text_domain' ),
                    'type'    => 'section_title',
                ),
                array(
                    'name'        => 'sm_popup',
            ...
            'vp_popup_gallery' => array(
                ...
                array(
                    ...
                    'label'   => esc_html__( 'Lightbox for WordPress Images', '@@text_domain' ),
                    'desc'    => esc_html__( 'Enable lightbox for WordPress native galleries and images.', '@@text_domain' ),
                    'type'    => 'toggle',
                    'default' => 'off',
                ),
                ...
                array(
                    ...
                    'options'   => array(
                        ...
                        '_self'         => esc_html__( 'Open in Frame (not recommended)', '@@text_domain' ),
                        'prevent-click' => esc_html__( 'Prevent Click', '@@text_domain' ),
                    ),
                    'is_pro'    => true,
                ),
                array(
