...
<div class="vp-portfolio__item-overlay vp-portfolio__item-align-<?php echo esc_attr( $args['style_options']['align'] ); ?>" data-vp-bg-color="<?php echo esc_attr( $args['style_options']['bg_color'] ); ?>" data-vp-text-color="<?php echo esc_attr( $args['style_options']['text_color'] ); ?>">
