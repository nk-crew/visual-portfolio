 ...
 */
class Visual_Portfolio_Block_Loop_Pagination_Infinite {
	/**
	 * Constructor.
	 */
	...
	public function register_block() {
		register_block_type_from_metadata(
			visual_portfolio()->plugin_path . 'gutenberg/blocks/loop-pagination-infinite',
			array(
	...
	public function block_render( $attributes, $content, $block ) {
		...
		return sprintf(
			'<a href="%1$s" %2$s><span>%3$s</span><span class="vp-block-loop-pagination-infinite-loading"><span class="vp-spinner"></span><span class="vp-screen-reader-text">%4$s</span></span></a>',
			$next_link,
			$wrapper_attributes,
			wp_kses_post( $label ),
...
new Visual_Portfolio_Block_Loop_Pagination_Infinite();
