 ...
 */
class Visual_Portfolio_Block_Loop_Pagination_Numbers {
	/**
	 * Constructor.
	 */
	...
	public function register_block() {
		register_block_type_from_metadata(
			visual_portfolio()->plugin_path . 'gutenberg/blocks/loop-pagination-numbers',
			array(
	...
	public function block_render( $attributes, $content, $block ) {
		...
		$wrapper_attributes = get_block_wrapper_attributes(
			array(
				'class' => 'vp-block-loop-pagination-numbers',
			)
		);
...
new Visual_Portfolio_Block_Loop_Pagination_Numbers();
